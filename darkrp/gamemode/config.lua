...
GM.Config.runspeed						= 340
-- searchtime - Number of seconds for which a search warrant is valid.
GM.Config.searchtime					= 180
...
GM.Config.mprintamountgold					= 550

GM.Config.mprintamountbronze					= 125
